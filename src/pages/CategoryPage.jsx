...
function CategoryPage() {
  ...
  const mockProducts = [
    ...
    },
    {
      ...
      price: 49.99,
      rating: 4.3,
      image: 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1528&q=80',
      discount: 0,
      categoryId: 2
    },
    {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (foundCategory) {
        ...
        const filteredProducts = mockProducts.filter(product => product.categoryId === parseInt(categoryId));
    ...
    //   try {
    //     const categoryResponse = await axios.get(`http://localhost:3001/categories/${categoryId}`);
    //     setCategory(categoryResponse.data);
    //     
    //     const productsResponse = await axios.get(`http://localhost:3001/products?categoryId=${categoryId}`);
